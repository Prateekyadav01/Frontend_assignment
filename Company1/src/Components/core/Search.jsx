...
const Search = () => {
  ...
  const handleSubmit =()=>{
    ...
    //   console.log(priceValue,propertyValue);
  }
  return (
    <div className='flex flex-col md:flex-row justify-evenly m-4 bg-slate-200 h-auto md:h-32 p-4 rounded-md'>
      <div className='flex flex-col mb-4 md:mb-0 border-r border-gray-400 pr-4'>
        ...
        <input onChange={(e)=>setCityValue(e.target.value)} type="text" placeholder="City Name" className='p-2 rounded-md border-2 border-gray-300' />
      </div>
      <div className='flex flex-col mb-4 md:mb-0 border-r border-gray-400 pr-4'>
      ...
      <div className='flex flex-col mb-4 md:mb-0 border-r border-gray-400 pr-4'>
        ...
        <select name="" id="" onChange={(e)=>setPriceValue(e.target.value)} className='p-2 rounded-md border-2 border-gray-300'>
      ...
      <div className='flex flex-col border-r border-gray-400 pr-4'>
        ...
        <select name="" id="" className='p-2 rounded-md border-2 border-gray-300' onChange={(e)=>setPropertyValue(e.target.value)}>
